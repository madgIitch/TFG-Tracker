...
import { getPhaseStyles } from '../../styles/screens/RegisterPhases.styles';
...
export const Phase4InvitationCode: React.FC<Props> = ({ onNext, onBack, loading }) => {
    ...
    const commonStyles = getPhaseStyles(theme);
    ...
    return (
        <View style={commonStyles.container}>
            ...
            <Text style={[commonStyles.subtitle, { textAlign: 'left', color: theme.colors.text }]}>
