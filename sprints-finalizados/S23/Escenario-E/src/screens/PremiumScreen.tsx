  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.systemBackground }]}>
      ...
      <View style={[styles.body, { paddingBottom: insets.bottom + 24 }]}>
        <Text style={[styles.bodyTitle, { color: theme.colors.text }]}>La mejor experiencia, muy pronto</Text>
        ...
        <TouchableOpacity style={[styles.notifyBtn, { backgroundColor: theme.colors.primary }]} onPress={() => navigation.goBack()}>
