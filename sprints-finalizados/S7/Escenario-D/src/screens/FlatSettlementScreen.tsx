        ...
        return (
            <View style={styles.card}>
                <View style={styles.cardTop}>
                    ...
                    <View style={[styles.avatarPlaceholder, { backgroundColor: 'rgba(124, 58, 237, 0.1)' }]}>
        ...
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            {loading ? (
                <View style={styles.centerContainer}>
                    ...
                    <Text style={{ marginTop: 12, color: theme.colors.text }}>Calculando balances...</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    emptyText: { marginTop: 16, fontSize: 20, fontWeight: '700', color: '#1F2937' },
    emptySubText: { marginTop: 8, fontSize: 16, color: '#6B7280', textAlign: 'center' },
