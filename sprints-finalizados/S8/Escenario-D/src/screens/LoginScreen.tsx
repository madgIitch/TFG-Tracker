...
import { View, Text, TextInput, StyleSheet, Alert, Image, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <KeyboardAvoidingView
      style={[styles.keyboardAvoiding, { backgroundColor: theme.colors.background }]}
