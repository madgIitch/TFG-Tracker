...
export const ChatScreen: React.FC = () => {
  ...
  const inputDockStyle = useMemo(
    () => [
      styles.inputDock,
      styles.inputDockBottom,
  ...
  const messagesContentStyle = useMemo(
    () => [styles.messagesList, { paddingBottom: 72 + inputOffset }],
    [inputOffset]
  );
  const inputRowStyle = useMemo(
    () => [styles.inputRow, { paddingBottom: inputOffset }],
    [inputOffset]
  );
