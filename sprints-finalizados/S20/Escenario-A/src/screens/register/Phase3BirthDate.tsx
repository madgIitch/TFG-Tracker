...
import { createPhase3BirthDateStyles } from '../../styles/screens/register/Phase3BirthDate.styles';
...
export const Phase3BirthDate: React.FC<Phase3BirthDateProps> = ({  
  ...
  const styles = React.useMemo(() => createPhase3BirthDateStyles(theme), [theme]);
