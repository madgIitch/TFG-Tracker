...
import { View, Text, TextInput, Alert, Image, KeyboardAvoidingView, Platform, ScrollView, TouchableOpacity } from 'react-native';  
...
import type { GoogleUserParams } from '../types/auth';
