...
export const AppNavigator: React.FC = () => {    
  ...
  const navigationTheme = useMemo(
    () => themeToNavigationTheme(theme, isDark),
    [isDark, theme]
  );
  ...
  return (    
    <NavigationContainer linking={linking} ref={navigationRef} theme={navigationTheme}>
      <SafeAreaView
        style={[styles.navigatorSafeArea, { backgroundColor: theme.colors.background }]}
...
const themeToNavigationTheme = (theme: ReturnType<typeof useTheme>, isDark: boolean) => {
