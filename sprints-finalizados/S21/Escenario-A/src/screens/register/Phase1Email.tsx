...
import { createPhase1EmailStyles } from '../../styles/screens/register/Phase1Email.styles';

interface Phase1EmailProps {
  onNext: (data: Phase1Data) => Promise<void>;
  onGoogleSignIn: () => void;
  onGoToLogin: () => void;
  loading: boolean;
  onInputFocus?: () => void;
...
export const Phase1Email: React.FC<Phase1EmailProps> = ({
  ...
  const styles = React.useMemo(() => createPhase1EmailStyles(theme), [theme]);
    ...
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Button
          ...
          variant="secondary"
        />
        <Button title="Continuar" onPress={() => handleNext().catch(() => undefined)} loading={loading} />
      </View>
    </View>
  );
};
