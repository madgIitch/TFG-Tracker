...
import { createPhase4InvitationCodeStyles } from '../../styles/screens/register/Phase4InvitationCode.styles';
...
export const Phase4InvitationCode: React.FC<Phase4InvitationCodeProps> = ({
  ...
  const styles = React.useMemo(() => createPhase4InvitationCodeStyles(theme), [theme]);
