...
import { createStyles } from '../styles/screens/MatchesScreen.styles';
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        <View style={styles.emptyState}>
          ...
          <Text style={[styles.emptyText, { color: theme.colors.text }]}>Cargando matches...</Text>
          <Text style={[styles.emptySubtitle, { color: theme.colors.textSecondary }]}>Sincronizando conversaciones y nuevos perfiles.</Text>
        </View>
        ...
        <View style={styles.emptyState}>
          ...
          {errorMessage ? (
            <View style={styles.retryWrap}>
              <Button title="Reintentar" onPress={() => loadData().catch(() => undefined)} variant="secondary" size="small" />
            </View>
          ) : null}
        </View>
      ) : (
