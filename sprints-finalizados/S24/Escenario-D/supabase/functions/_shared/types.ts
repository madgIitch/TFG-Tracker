...
export interface Profile {
  ...
  // Ubicaciones Reales (Reemplaza preferred_zones string array simple)
  preferred_city_id?: string | null
  preferred_zone_ids?: string[]
  preferred_zones?: string[] // legacy
}
...
export interface Flat {
  ...
  owner_id: string
  address: string
  city: string // legacy etiqueta
  district?: string // legacy etiqueta
  city_id?: string
...
// ====================
// Tipos para Gastos Compartidos (Flat Expenses & Settlements)
// ====================
