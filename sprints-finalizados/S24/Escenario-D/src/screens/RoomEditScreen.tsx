...
import { getStyles } from '../styles/screens/RoomEditScreen.styles';
...
export const RoomEditScreen: React.FC = () => {  const theme = useTheme();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isCreateMode) {
        ...
        await roomService.updateRoom(room.id, updatePayload);
