...
export const makeStyles = (theme: Theme) => StyleSheet.create({
  ...
  balancePositive: { color: theme.colors.successText },
  ...
  settlementCardMyDebt: { borderColor: 'rgba(239, 68, 68, 0.30)', backgroundColor: theme.colors.dangerBg },
  ...
  hintGreen: { color: theme.colors.successText },
  settleButton: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  settledBadgeText: { fontSize: 11, color: theme.colors.successText, fontWeight: '600' },
});
