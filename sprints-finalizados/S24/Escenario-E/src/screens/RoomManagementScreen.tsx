...
import { roomTypeLabel, commonAreaLabel, getRuleIcon, getServiceIcon } from '../constants/roomLabels';
        ...
        >
          {flats.length === 0 ? (
            ...
            <>
              ...
              <FormSection title="Ubicación" iconName="location-outline">
                <Text style={styles.detailText}>{selectedFlat?.address}</Text>
                {selectedFlat?.city ? (
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (!selectedFlatId || !selectedFlat) {
                      Alert.alert('Aviso', 'Selecciona un piso primero.');
                      return;
                    }
                    navigation.navigate('EditFlatLocation', {
                      flatId: selectedFlatId,
                      address: selectedFlat.address,
                      cityName: selectedFlat.city,
                      cityId: selectedFlat.city_id,
                      zoneName: selectedFlat.district,
                      zoneId: selectedFlat.district_id,
                    });
                  }}
                >
                  <Text style={styles.inlineActionText}>Editar ubicación</Text>
                </TouchableOpacity>
              </FormSection>
