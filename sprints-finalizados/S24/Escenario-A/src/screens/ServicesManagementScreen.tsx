...
import { createServicesManagementStyles } from '../styles/screens/ServicesManagementScreen.styles';
...
export const ServicesManagementScreen: React.FC = () => {
  ...
  const styles = useMemo(() => createServicesManagementStyles(theme), [theme]);
