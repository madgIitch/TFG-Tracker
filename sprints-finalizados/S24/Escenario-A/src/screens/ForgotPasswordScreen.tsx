...
import { createForgotPasswordStyles } from '../styles/screens/ForgotPasswordScreen.styles';
...
export const ForgotPasswordScreen: React.FC = () => {
  ...
  const { handleInputFocus } = useKeyboardAutoScroll({ extraOffset: 84 });
